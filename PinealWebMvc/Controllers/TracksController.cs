...
namespace PinealWebMvc.Controllers
{
    public class TracksController : Controller
    {
        ...
        public TracksController(PinealWebMvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Link,Lançamento,TrackProperty,Amount")] Track track)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Link,Lançamento,TrackProperty,Amount")] Track track)
        {
            if (id != track.Id)
            {
                return NotFound();
